package br.org.eldorado.pagemarker.persistence.provider;

import br.org.eldorado.pagemarker.persistence.database.BookTable;
import br.org.eldorado.pagemarker.persistence.database.MarkerTable;
import br.org.eldorado.pagemarker.persistence.database.PageMarkerHelper;
...
public class MarkerContentProvider extends ContentProvider {
        ...
        private static final String AUTHORITY = "br.org.eldorado.pagemarker.persistence.provider.markercontentprovider";
        ...
        public String getType(Uri uri) {
                ...
                // Retrieve the match between the passed uri and the registered
                // uris
                int uriMatch = _uriMatcher.match(uri);
